...
export class NewscreportComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private router: Router, private loginService: LoginService, private http: HttpClient, private _global: AppGlobals, private ismsreportService: IsmsreportService, private workFlowsService: WorkflowsService) {
    ...
    this.columnDefs = [
      ...
      { headerName: 'Test MSISDN', field: 'testMsisdn', sortable: true, filter: true, width: 210 },
      { headerName: 'Qty', field: 'qty', sortable: true, filter: true, width: 210 },
      { headerName: 'Ngvs Voucher Status Updated', field: 'ngvsVoucherStatusUpdated', sortable: true, filter: true, width: 210 },
      ...
      { headerName: 'Test start serial', field: 'scStartSlNo', sortable: true, filter: true, width: 210 },
      { headerName: 'Test end serial', field: 'scEndSlNo', sortable: true, filter: true, width: 210 },
