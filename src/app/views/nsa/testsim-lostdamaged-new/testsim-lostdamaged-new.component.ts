...
@Component({
    selector: 'app-testsim-lostdamaged-new',
    templateUrl: './testsim-lostdamaged-new.component.html',
    styleUrls: ['./testsim-lostdamaged-new.component.scss'],
    providers: [WorkflowsService, AppGlobals, LoginService],
    standalone: false
})
export class TestsimLostdamagedNewComponent implements OnInit {
  ...
  lost(){
    ...
    this.workFlowsService.doPendingSimActionExistsForRqnLineMsisdnId(this.tmp).subscribe(
      data => {
        console.log(data);
        if(data['message'] == "SUCCESS") this.router.navigate(['nsa/testsim-lost', this.selectedIds]);
      },
    err => {
      console.error(err);
  ...
  damaged(){
    ...
    this.workFlowsService.doPendingSimActionExistsForRqnLineMsisdnId(this.tmp).subscribe(
      data => {
        console.log(data);
        if(data['message'] == "SUCCESS")     this.router.navigate(['nsa/testsim-damaged', this.selectedIds]);
      },
    err => {
      console.error(err);
      alert("One or more pending requests exist against selected MSISDNs");
