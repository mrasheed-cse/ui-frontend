...
@Component({
  selector: 'app-testsim-surrender-ssm',
  templateUrl: './testsim-surrender-ssm.component.html',
  styleUrls: ['./testsim-surrender-ssm.component.scss'],
	providers: [WorkflowsService,AppGlobals,LoginService],
})
export class TestsimSurrenderSsmComponent implements OnInit {
  ...
  loadPendingList(){
    //GetPendingTaskList
    this.workFlowsService.simActionRequestsPendingForApproval(this._global.wrid_testSimSurrender,this.userID).subscribe(
        data => {
          if(data !=null){
            console.log(data);
