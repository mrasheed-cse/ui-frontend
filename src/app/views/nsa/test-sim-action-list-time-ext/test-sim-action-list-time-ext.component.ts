...
@Component({
  selector: 'app-test-sim-action-list-time-ext',
  templateUrl: './test-sim-action-list-time-ext.component.html',
  styleUrls: ['./test-sim-action-list-time-ext.component.scss'],
	providers: [WorkflowsService,AppGlobals,LoginService],
})
export class TestSimActionListTimeExtComponent implements OnInit {
  ...
  constructor(private router: Router,private loginService: LoginService,private activatedRoute: ActivatedRoute,private http: HttpClient, private _global: AppGlobals, private workFlowsService: WorkflowsService) {
    ...
    this.columnDefs = [
        ...
        {headerName: 'New end date', field: 'newEndDateAsString', sortable: false, filter: false, width: 140 },
  ...
  loadPendingList(){
    ...
    this.workFlowsService.loadSimActionListWithSearch(
      this.userID,
      this._global.wrid_testSimTimeLimitExtension,
