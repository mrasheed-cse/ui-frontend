...
@Component({
    selector: 'app-test-sim-action-list-transfer',
    templateUrl: './test-sim-action-list-transfer.component.html',
    styleUrls: ['./test-sim-action-list-transfer.component.scss'],
    providers: [WorkflowsService, AppGlobals, LoginService],
    standalone: false
})
export class TestSimActionListTransferComponent implements OnInit {
  ...
  constructor(private router: Router,private loginService: LoginService,private activatedRoute: ActivatedRoute,private http: HttpClient, private _global: AppGlobals, private workFlowsService: WorkflowsService) {
    ...
    this.columnDefs = [
        ...
        {headerName: 'Mode', field: 'transferMode', sortable: false, filter: false, width: 90 },
        {headerName: 'Transfer to', field: 'transferToUserFullName', sortable: false, filter: false, width: 140 },
  ...
  loadPendingList(){
    ...
    this.workFlowsService.loadSimActionListWithSearch(
      this.userID,
      this._global.wrid_testSimTransfer,
