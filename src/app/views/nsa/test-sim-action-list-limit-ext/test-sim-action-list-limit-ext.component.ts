...
export class TestSimActionListLimitExtComponent implements OnInit {
  ...
  constructor(private router: Router,private loginService: LoginService,private http: HttpClient, private _global: AppGlobals, private workFlowsService: WorkflowsService) {
    ...
    this.columnDefs = [
        ...
        {headerName: 'Req Type', field: 'reqType', sortable: true, filter: true, width: 200 },
        {headerName: 'SIM Status', field: 'simStatusAsString', sortable: true, filter: true, width: 100 },
        {headerName: 'Approval Status', field: 'approvalStatus', sortable: true, filter: true, width: 100 },
        {headerName: 'Pending at', field: 'hop', sortable: true, filter: true, width: 100 },
        {headerName: 'Req date', field: 'requestDate', sortable: true, filter: true, width: 130, type: ["dateColumn", "nonEditableColumn"] },
