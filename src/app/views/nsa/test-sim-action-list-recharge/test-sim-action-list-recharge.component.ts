...
@Component({
  selector: 'app-test-sim-action-list-recharge',
  templateUrl: './test-sim-action-list-recharge.component.html',
  styleUrls: ['./test-sim-action-list-recharge.component.scss'],
	providers: [WorkflowsService,AppGlobals,LoginService],
})
export class TestSimActionListRechargeComponent implements OnInit {
  ...
  constructor(private router: Router,private loginService: LoginService,private http: HttpClient, private _global: AppGlobals, private workFlowsService: WorkflowsService) {
    ...
    this.columnDefs = [
        ...
        {headerName: 'Recharge amount', field: 'rechargeAmount', sortable: true, filter: true, width: 140 },
  ...
  loadPendingList(){
    ...
    this.workFlowsService.loadSimActionListWithSearch(
      this.userID,
      this._global.wrid_testSimRecharge,
