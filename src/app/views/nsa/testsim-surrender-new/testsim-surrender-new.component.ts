...
@Component({
  selector: 'app-testsim-surrender-new',
  templateUrl: './testsim-surrender-new.component.html',
  styleUrls: ['./testsim-surrender-new.component.scss'],
	providers: [WorkflowsService,AppGlobals,LoginService],
})
export class TestsimSurrenderNewComponent implements OnInit {
  ...
  surrender(){
    ...
    this.workFlowsService.doPendingSimActionExistsForRqnLineMsisdnId(this.tmp).subscribe(
      data => {
        console.log(data);
        if(data['message'] == "SUCCESS") this.router.navigate(['nsa/testsim-surrender', this.selectedIds]);
      },
    err => {
      console.error(err);
